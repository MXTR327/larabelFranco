                                ...
                                <form action="{{route('productos.store')}}" method="post" enctype="multipart/form-data" class="form-horizontal">
                                   {{csrf_field()}}
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><textarea name="descripcion" id="textarea-input" rows="9" placeholder="Ingrese descripcion del producto..." class="form-control"></textarea></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Precio</label></div>
                                        <div class="col-12 col-md-9"><input type="number" id="text-input" name="precio" placeholder="Ingrese Precio..." class="form-control"><small class="form-text text-muted"></small></div>
                                    </div>
                                    <div class="row form-group">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div><input  class="btn btn-success" type="submit" id="file-input"  value="Crear"></div>
                                    </div>
                                </form>
                            </div>
